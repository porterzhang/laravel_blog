...
class ArticleController extends Controller
{
    ...
    {
        return view('admin/article/index')->withArticles(Article::where([])->orderBy("id",'desc')->get());
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin/article/edit')->with("article_info", $article_info);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $article_info->title = $request->get('title'); // 将 POST 提交过了的 title 字段的值赋给 article 的 title 属性
        $article_info->body = $request->get('body'); // 同上
